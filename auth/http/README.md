...
This package is for the default session auth flow used by admin dashboards, internal control planes, and shared-secret applications. Login uses JSON credentials and refresh cookies.
